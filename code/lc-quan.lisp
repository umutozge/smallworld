...
(defpackage "LC-Q"
  (:use "COMMON-LISP")
  (:export "ETA-NORMALIZE" "BETA-NORMALIZE-OUTER" "MK-A"))
...
(defun mk-v (sym) sym)
(defun is-v (e) (and (symbolp e) (not (member e *operators*)))) 
...
(defun is-q (e) (and (consp e) (= (length e) 3) (member (car e) *quantifiers*) (is-v (cadr e))))
